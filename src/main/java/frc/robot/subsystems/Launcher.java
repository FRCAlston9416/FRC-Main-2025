...
public class Launcher extends SubsystemBase{
    ...
    public Launcher() {
        ...
        launchMotor.configure(launchMotorConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
        
        SparkMaxConfig secondaryMotorConfig = new SparkMaxConfig();
